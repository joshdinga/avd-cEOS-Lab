...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_CW_Leaf1_Ethernet1 | - | 172.31.255.0/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_CW_Leaf2_Ethernet1 | - | 172.31.255.4/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_CW_Leaf1_Ethernet1
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_CW_Leaf2_Ethernet1
   no shutdown
   mtu 9214
   no switchport
...
router bgp 65001
   ...
   neighbor 172.31.255.1 description CW_Leaf1_Ethernet1
   neighbor 172.31.255.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.5 remote-as 65102
   neighbor 172.31.255.5 description CW_Leaf2_Ethernet1
