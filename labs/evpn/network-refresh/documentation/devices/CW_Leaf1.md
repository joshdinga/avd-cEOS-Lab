...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | SERVER_ESX_Host_1_Eth1 | *trunk | *2-4000 | *- | *- | 3 |
| Ethernet4 | SERVER_ESX_Host_1_Eth2 | *trunk | *2-4000 | *- | *- | 3 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_CW_Spine1_Ethernet1 | - | 172.31.255.1/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_CW_Spine2_Ethernet1 | - | 172.31.255.3/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_CW_Spine1_Ethernet1
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_CW_Spine2_Ethernet1
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet3
   description SERVER_ESX_Host_1_Eth1
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description SERVER_ESX_Host_1_Eth2
   no shutdown
   channel-group 3 mode active
```
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 109 | 192.168.255.3:10109 | 10109:10109 | - | - | learned |
| 601 | 192.168.255.3:10601 | 10601:10601 | - | - | learned |
| 3401 | 192.168.255.3:13401 | 13401:13401 | - | - | learned |
| 3402 | 192.168.255.3:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| sgc-dc | 192.168.255.3:11 | connected | - |
| sgc_gaming | 192.168.255.3:10 | connected | - |
...
router bgp 65101
   ...
   neighbor 172.31.255.0 description CW_Spine1_Ethernet1
   neighbor 172.31.255.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.2 remote-as 65001
   neighbor 172.31.255.2 description CW_Spine2_Ethernet1
   ...
   !
   vlan 109
      rd 192.168.255.3:10109
      route-target both 10109:10109
      redistribute learned
   !
   vlan 601
      rd 192.168.255.3:10601
      route-target both 10601:10601
      redistribute learned
   !
   vlan 3401
      rd 192.168.255.3:13401
      route-target both 13401:13401
      redistribute learned
   !
   vlan 3402
      rd 192.168.255.3:13402
