...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_CW_Leaf1_Ethernet2 | - | 172.31.255.2/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_CW_Leaf2_Ethernet2 | - | 172.31.255.6/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_CW_Leaf1_Ethernet2
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_CW_Leaf2_Ethernet2
   no shutdown
   mtu 9214
   no switchport
...
router bgp 65001
   ...
   neighbor 172.31.255.3 description CW_Leaf1_Ethernet2
   neighbor 172.31.255.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.7 remote-as 65102
   neighbor 172.31.255.7 description CW_Leaf2_Ethernet2
   neighbor 192.168.255.3 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.3 remote-as 65101
   neighbor 192.168.255.3 description CW_Leaf1_Loopback0
   neighbor 192.168.255.4 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.4 remote-as 65102
   neighbor 192.168.255.4 description CW_Leaf2_Loopback0
