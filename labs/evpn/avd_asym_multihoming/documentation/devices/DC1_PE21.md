...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | SERVER_server03_Eth1 | *trunk | *110 | *- | *- | 3 |
| Ethernet4 | SERVER_server04_Eth1 | *trunk | *111 | *- | *- | 4 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_DC1_SPINE1_Ethernet3 | - | 172.31.255.9/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_DC1_SPINE2_Ethernet3 | - | 172.31.255.11/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_DC1_SPINE1_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_DC1_SPINE2_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet3
   description SERVER_server03_Eth1
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description SERVER_server04_Eth1
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | PortChannel3 | trunk | 110 | - | - | - | - | - | 0000:0000:0201:0202:0033 |
| Port-Channel4 | PortChannel4 | trunk | 111 | - | - | - | - | - | 0000:0000:0201:0202:0044 |
...
| 111 | 192.168.255.5:10111 | 10111:10111 | - | - | learned |
