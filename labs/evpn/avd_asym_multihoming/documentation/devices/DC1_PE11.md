...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.4/24 | 172.100.100.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | SERVER_server01_Eth1 | *trunk | *110 | *- | *- | 3 |
| Ethernet4 | SERVER_server02_Eth1 | *trunk | *111 | *- | *- | 4 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_DC1_SPINE1_Ethernet1 | - | 172.31.255.1/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_DC1_SPINE2_Ethernet1 | - | 172.31.255.3/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_DC1_SPINE1_Ethernet1
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_DC1_SPINE2_Ethernet1
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | PortChannel3 | trunk | 110 | - | - | - | - | - | 0000:0000:2b85:9c92:b1bd |
| Port-Channel4 | PortChannel4 | trunk | 111 | - | - | - | - | - | 0000:0000:0101:0102:0044 |
...
| --------- | --------------------------- | --------------------------- | ------------ |
| Port-Channel3 | 0000:0000:2b85:9c92:b1bd | all-active | 2b:85:9c:92:b1:bd |
| Port-Channel4 | 0000:0000:0101:0102:0044 | all-active | 01:01:01:02:00:44 |
...
interface Port-Channel3
   ...
   evpn ethernet-segment
      identifier 0000:0000:2b85:9c92:b1bd
      route-target import 2b:85:9c:92:b1:bd
   lacp system-id 2b85.9c92.b1bd
...
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.254.3/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 192.168.255.3:10110 | 10110:10110 | - | - | learned |
| 111 | 192.168.255.3:10111 | 10111:10111 | - | - | learned |
...
router bgp 65101
   ...
   neighbor 192.168.255.1 description DC1_SPINE1_Loopback0
   neighbor 192.168.255.2 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.2 remote-as 65001
   neighbor 192.168.255.2 description DC1_SPINE2_Loopback0
